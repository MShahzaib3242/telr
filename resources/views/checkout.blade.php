                        ...
                        <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                            <form action="{{route('checkout.store')}}" method="POST">
                                ...
                                <div class="form-row">
                                    ...
                                    <input type="email" class="form-control" id="validationDefault02" placeholder="Email Address" name="email" required>
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="col-md-6 mb-3">
                                    <label for="validationDefault03">Building No / Flat No</label>
                                    <input type="text" class="form-control" id="validationDefault03" placeholder="Building No." name="address" required>
                                    </div>
                                    <div class="col-md-3 mb-3">
                                    <label for="validationDefault04">Street / Area</label>
                                    <input type="text" class="form-control" id="validationDefault04" placeholder="State" name="area" required>
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="validationDefault04" placeholder="State" name="country" required>
                                    </div>
                                    <div class="col-md-3 mb-3">
